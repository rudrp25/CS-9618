...
ThisCar = Car("ABC123", 2500)
ThisCar.SetPurchasePrice(12000)
ThisCar.SetRegistration("abcd")
ThisCar.SetDateOfRegistration("28-08-2025")

print(ThisCar.GetVehicleID())
print(ThisCar.GetEngineSize())
print(ThisCar.GetPurchasePrice())
print(ThisCar.GetRegistration())
print(ThisCar.GetDateOfRegistration())
